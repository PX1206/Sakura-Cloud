...
CREATE TABLE `t_product`  (
  ...
  `product_name` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品名称',
  `product_no` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品编号',
  `unit_price` int(11) NULL DEFAULT NULL COMMENT '单价，单位为分',
