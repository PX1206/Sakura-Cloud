...
CREATE TABLE `t_order`  (
  ...
  `order_no` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '订单号',
  `product_no` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品编号',
  `num` int(11) NULL DEFAULT NULL COMMENT '数量',
  `total_price` int(11) NULL DEFAULT NULL COMMENT '总价格，单位为分',
...
) ENGINE = InnoDB AUTO_INCREMENT = 125 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单表' ROW_FORMAT = Dynamic;
